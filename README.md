...
[![Go Reference](https://pkg.go.dev/badge/github.com/andrecego/discordgo.svg)](https://pkg.go.dev/github.com/andrecego/discordgo) [![Go Report Card](https://goreportcard.com/badge/github.com/andrecego/discordgo)](https://goreportcard.com/report/github.com/andrecego/discordgo) [![CI](https://github.com/andrecego/discordgo/actions/workflows/ci.yml/badge.svg)](https://github.com/andrecego/discordgo/actions/workflows/ci.yml) [![Discord Gophers](https://img.shields.io/badge/Discord%20Gophers-%23discordgo-blue.svg)](https://discord.gg/golang) [![Discord API](https://img.shields.io/badge/Discord%20API-%23go_discordgo-blue.svg)](https://discord.com/invite/discord-api)
...
```go
import "github.com/andrecego/discordgo"
```
...
- [![Go Reference](https://pkg.go.dev/badge/github.com/andrecego/discordgo.svg)](https://pkg.go.dev/github.com/andrecego/discordgo) 
...
- [DiscordGo Examples](https://github.com/andrecego/discordgo/tree/master/examples) - A collection of example programs written with DiscordGo
- [Awesome DiscordGo](https://github.com/andrecego/discordgo/wiki/Awesome-DiscordGo) - A curated list of high quality projects using DiscordGo

## Troubleshooting
For help with common problems please reference the 
[Troubleshooting](https://github.com/andrecego/discordgo/wiki/Troubleshooting) 
